...
if __name__ == '__main__':
    ...
    env = game.snake_environement(width, height, move_limit, block_size, visual=True)
    ...
    agent = Agent(n_actions = n_actions, batch_size = batch_size, learning_rate = learning_rate, num_epochs = num_learning_epochs, input_dims = input_dims)
    ...
    plt.savefig('Snake/Score_Graph.png')